...
docker run --rm -d --network host --privileged --name nomachine-xfce4 -e PASSWORD=11111 -e USER=bacox --cap-add=SYS_PTRACE --shm-size=12g thuonghai2711/nomachine-ubuntu-desktop:xfce4
